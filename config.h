...
static const char selbordercolor[]  = "#f0b111"; /* "#005577"; "#00775b"; */
static const char selbgcolor[]      = "#f0b111"; /* "#00775b"; */
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = emacs   } },
   	{ MODKEY|ShiftMask,             XK_n,      spawn,          {.v = upvol   } },
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = downvol } },
